@charset "UTF-8";
:root { --polaris-version-number: '10.3.1'; }
...
.Polaris-Choice { display: inline-flex; justify-content: flex-start; padding: var(--p-space-1) 0; cursor: pointer; }
...
@media (max-width: 47.99688em) { .Polaris-Choice__Control { --pc-choice-size: 1.375rem; } }
...
@media (max-width: 47.99688em) { .Polaris-Choice__Descriptions { --pc-choice-size: 1.375rem; } }
...
.Polaris-Checkbox__Icon { position: absolute; top: 50%; left: 50%; transform-origin: 50% 50%; pointer-events: none; transform: translate(-50%, -50%) scale(0.25); opacity: 0; transition: opacity var(--p-duration-100) var(--p-ease), transform var(--p-duration-100) var(--p-ease); }
...
@media (max-width: 30.62187em) { .Polaris-BulkActions__ButtonGroupWrapper > div > div:first-child { flex: 1 1 auto; } }
...
@media (max-width: 47.99688em) { .Polaris-RadioButton__Backdrop { --pc-icon-size-small: 0.625rem; } }
...
@media (max-width: 47.99688em) { .Polaris-ChoiceList__ChoiceItem:not(:last-child) { margin-bottom: var(--p-space-4); } }
...
@media (max-width: 47.99688em) { .Polaris-ChoiceList__ChoiceChildren { margin-top: var(--p-space-4); } }

.Polaris-ChoiceList__ChoiceError { margin-top: var(--p-space-1); margin-bottom: var(--p-space-2); }

@media (max-width: 47.99688em) { .Polaris-ChoiceList__ChoiceError { margin-top: var(--p-space-4); } }
...
@media (max-width: 47.99688em) { .Polaris-ChoiceList__Title { margin-bottom: var(--p-space-5); } }
...
@media (max-width: 47.99688em) { .Polaris-DataTable__FixedFirstColumn { z-index: 1; } }
...
@media (max-width: 47.99688em) { .Polaris-Modal-Dialog__Modal { bottom: 0; max-height: 100%; } }
...
.Polaris-IndexTable__TableHeadingSortButton { background: none; padding: 0; border: 0; cursor: pointer; display: flex; align-items: center; justify-content: center; font-weight: var(--p-font-weight-medium); color: var(--p-text-subdued); font-size: var(--p-font-size-75); }
...
.Polaris-IndexTable__TableHeadingSortIcon { order: 1; opacity: 0; transition: var(--p-ease) var(--p-duration-150) opacity; }
...
@media (max-width: 47.99688em) { .Polaris-MediaCard { flex-flow: column nowrap; } }
...
@media (max-width: 47.99688em) { .Polaris-MediaCard__ActionContainer { padding-top: var(--p-space-8); } }
...
@media (max-width: 47.99688em) { .Polaris-Navigation__LogoContainer { display: flex; flex: 0 0 3.5rem; align-items: center; height: 3.5rem; padding: 0 var(--p-space-2) 0 var(--p-space-4); background-color: var(--p-surface); box-shadow: var(--p-shadow-top-bar); margin-bottom: var(--p-space-4); flex-basis: 3.5rem; flex-basis: calc(3.5rem + constant(safe-area-inset-left)); flex-basis: calc(3.5rem + env(safe-area-inset-left)); padding-left: var(--p-space-4); padding-left: calc(var(--p-space-4) + constant(safe-area-inset-left)); padding-left: calc(var(--p-space-4) + env(safe-area-inset-left)); } }
...
@media (max-width: 47.99688em) { .Polaris-Navigation__Text { font-size: 0.9375rem; line-height: var(--p-font-line-height-2); } }
...
@media (max-width: 30.62187em) { .Polaris-Page-Header--noBreadcrumbs .Polaris-Page-Header__RightAlign { margin-left: 0; } }
...
@media (max-width: 64.99688em) { .Polaris-Page-Header--longTitle .Polaris-Page-Header__AdditionalMetaData { margin-left: 0; }
...
@media (max-width: 47.99688em) { .Polaris-Page-Header--mediumTitle:not(.Polaris-Page-Header--noBreadcrumbs) .Polaris-Page-Header__AdditionalMetaData { margin-left: 0; }
...
@media (max-width: 64.99688em) { .Polaris-ResourceItem:hover:not(.Polaris-ResourceItem--persistActions) .Polaris-ResourceItem__Actions { display: none; } }
...
@media (max-width: 30.62187em) { .Polaris-ResourceItem__Handle { visibility: hidden; }
...
@media (max-width: 64.99688em) { .Polaris-ResourceItem__Actions { display: none; } }
...
@media (max-width: 64.99688em) { .Polaris-ResourceItem--persistActions .Polaris-ResourceItem__Actions { display: none; } }
...
@media (max-width: 64.99688em) { .Polaris-ResourceItem__Disclosure { display: flex; flex: 0 0 var(--pc-resource-item-disclosure-width); justify-content: center; align-items: center; } }
...
@media (max-width: 64.99688em) { .Polaris-SkeletonPage__TitleAndPrimaryAction { display: block; } }
...
@media (max-width: 64.99688em) { .Polaris-SkeletonPage__PrimaryAction { margin-top: var(--p-space-4); margin-bottom: calc(var(--p-space-2)*-1); } }
...
@media (max-width: 64.99688em) { .Polaris-SkeletonPage__Action:not(:last-child) { display: none; } }
...
@media (max-width: 47.99688em) { .Polaris-TopBar-Menu__Activator { margin: 0; }
...
@media (max-width: 47.99688em) { .Polaris-TopBar-UserMenu__Details { display: none; } }
...
.Polaris-VideoThumbnail__PlayButton { --pc-play-button-focused-state-overlay: rgba(223, 227, 232, 0.3); position: absolute; top: 0; left: 0; width: 100%; height: 100%; padding: 0; border: none; background: transparent; opacity: 0.8; transition: opacity var(--p-duration-200) var(--p-ease-in); cursor: pointer; }
...
.Polaris-VideoThumbnail__PlayIcon { position: absolute; top: 50%; left: 50%; width: 3.75rem; height: 3.75rem; margin-top: -1.875rem; margin-left: -1.875rem; }

.Polaris-VideoThumbnail__Timestamp { position: absolute; bottom: 0; padding: 0 var(--p-space-1); margin-bottom: var(--p-space-2); margin-left: var(--p-space-2); border-radius: var(--p-border-radius-1); color: var(--p-text); background-color: var(--p-surface); opacity: 0.8; text-align: center; }

.Polaris-VideoThumbnail--withProgress { margin-bottom: var(--p-space-3); }
